...
!(function() {
  ...
  var o = [],
    n = 0,
    e = 0,
    t = { window: 'object' == typeof window, module: 'object' == typeof module && 'object' == typeof module.exports, amd: 'function' == typeof define && define.amd, global: 'object' == typeof global },
    r = { defineProp: 'undefined' != typeof Object.defineProperty },
    a = { valuesCount: 1e4, randomInterval: 30, removeOptions: !0 },
    d = {}
  ...
  d.randomInterval && setInterval(f.randomChanger, d.randomInterval),
    (f.valueOf = f),
    (f.options = d),
    r.defineProp &&
      (Object.defineProperty(f, 'random', {
        get: function() {
          return f()
        },
      }),
